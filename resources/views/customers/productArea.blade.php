            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <form  action="{{ route('addCart') }}" method="POST">
                    ...
                    <table class="table table-report -mt-2">
                        <thead>
                            <tr>
                                <th class="text-center whitespace-nowrap">SELECT</th>
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">
                                        <input type="number" name="quantities[{{ $product->id }}]" class="quantity-input border-2 border-gray-800" min="1" value="1">
                                    </td>
                                </tr>
                            @endforeach
                            @error('quantity')
                    ...
                    <button type="submit" class="btn btn-primary flex justify-center items-center mt-5" id="add-selected-products">Add Selected Products to Cart</button>
                </form>
            </div>
        </div>
    </div>
